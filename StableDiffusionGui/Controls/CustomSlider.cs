...
namespace StableDiffusionGui.Controls
{
    public class CustomSlider : HTSlider
    {
        ...
        private bool HasValueBox
        { get { return ValueBox != null && ValueBox is TextBox; } }

        public decimal ActualValue
        { get { return Value / _conversionFactor; } set { Value = ((double)(value * _conversionFactor)).RoundToInt().Clamp(Minimum, Maximum); UpdateValueBox(); } }

        [Browsable(false)]
        public int ActualValueInt
        { get { return (int)ActualValue; } }

        [Browsable(false)]
        public float ActualValueFloat
        { get { return (float)ActualValue; } }

        private decimal _valueStep = 0.2m;
        public decimal ValueStep
        { get { return _valueStep; } set { _valueStep = value; UpdateProperties(); } }

        private decimal _actualMinimum = 0.2m;
        public decimal ActualMinimum
        { get { return _actualMinimum; } set { _actualMinimum = value; UpdateProperties(); } }

        private decimal _actualMaximum = 10.0m;
        public decimal ActualMaximum
        { get { return _actualMaximum; } set { _actualMaximum = value; UpdateProperties(); } }
